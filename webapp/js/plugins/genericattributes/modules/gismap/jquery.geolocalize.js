...
<link rel="stylesheet" type="text/css" href="css/plugins/gismap/gismap.css" media="screen, projection, print"/>
...
<link rel="stylesheet" type="text/css" href="js/plugins/gismap/openlayers/default/style.css" />
<script src="js/jquery.geolocalize.js" type="text/javascript"></script>
<script src="js/plugins/gismap/LABjs-1.0.2rc1/LAB.js" type="text/javascript"></script>
<script src="js/plugins/gismap/gismap.js" type="text/javascript"></script>
<script type="text/javascript">
	$("#searchTextField").geolocalize( {gismapCode: MAP_GIS_CODE });
</script>
...
var GeolocUtils = {
	...
	showMap : function( ) 
	{
		...
		var baseUrl = $('base').attr('href');
				$LAB
					...
					.wait(function(){
						$.get(baseUrl +'/jsp/site/plugins/gismap/DoDisplayMap.jsp?map_name='+idMapDiv+'&gismap_code='+GeolocUtils.params.gismapCode, 
								function(data){
									$("#"+idMapDiv).html(data);
									$("#"+idMapDiv).show();
								});
	...
	setGeoInputField: function ( data ) 
	{
		$("input[name='" + GeolocUtils.params.inputGeoName + "']").val(data);
	},
	...
	getGeoInputField: function (  ) 
	{
		return $("input[name='" + GeolocUtils.params.inputGeoName + "']").val();
	},
...
jQuery.fn.geolocalizeSuggestPOI = function(params) {
	params = $.extend({
		inputLngName : "lng",	    // ID of the longitude input text field.
		inputLatName : "lat",		// ID of the latitude input text field.
		inputGeoName : "geo",		// ID of the latitude input text field.
